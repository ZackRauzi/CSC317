...
3. **Routine Tracking**
    - Fill out routine fields with exersize info (sets / reps / weight)
    - Track stats, date, time

4. **Routine Log**
    - Display a log of past routines with a summary at the end of every completed routine
